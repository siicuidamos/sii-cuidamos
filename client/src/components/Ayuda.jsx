    ...
    return (
      <div>
        ...
        <p>
          ...
          financiados con regalias en el territorio nacional y permitirles
          participar en el seguimiento de los mismos. En esta sección te{' '}
          <b>ayudaremos a entender los términos</b> utilizados en este contexto.
        </p>
        ...
        <div>
          <p>
            ...
            <br />
            Es el código único que identifica cada uno de los proyectos para el
          ...
          <p>
            ...
            <br />
            <b>Aprobado: </b> Esta listo para empezar la ejecución o ya está en
            ejecución.
            <br />
            ...
            <br />
            <b>En Actualizacion: </b> Se está actualizando cierta Información
            del proyecto.
            <br />
            <b>Formulado Para Registrar: </b> Ha sido presentado, pero no
            revisado.
            <br />
            ...
            <br />
            <b>No Viable: </b> No se realiza el proyecto porque existen
            circunstancias por las cuales no se puede llevar a cabo.
            <br />
          </p>
          <hr />
          <p>
            ...
            <br />
            Indica el monto de dinero del Sistema General de Regalías (SGR) con
            el cual será financiado el proyecto
          </p>
          ...
          <p>
            ...
            &nbsp;
            <b>OCAD: </b>Corporación Autónoma Regional Del Río Grande De La
            Magdalena - Cormagdalena
            <br />
            Es la organización encargada de evalúar, viabilizar, aprobar y
            priorizar los programas y proyectos que serán financiados con
          ...
          <p>
            ...
            <br />
            Es el tiempo que se establece que durará el proyecto, tiene un año
            de inicio (tras la aprobación del proyecto) y un año en el que se
