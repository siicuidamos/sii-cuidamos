      ...
      array.forEach(contenido => {
        ...
        divs.push(
          <Link to={link} style={{ textDecoration: 'none' }}>
            <div
              className="shadow card col-11 mx-2 my-3 proyecto-general"
              key={contenido.bpin}
            >
              <div className="row">
  ...
  verComentariosReportados() {
    ...
    if (this.state.infoComentarios.comentariosReportados !== 0) {
      ...
      return (
        <div className="container-fluid">
          <div
            className="row alert alert-success col-12 text-center justify-content-center mt-3"
            role="alert"
          >
          ...
          <div className="col-md-2 col-lg-2 col-sm-12 bg-secondary px-0 py-0 mx-0 my-0">
            <div className="list-group" id="list-tab" role="tablist">
              ...
              <a
                ...
                id="list-reportados-list"
                data-toggle="list"
                href="#list-reportados"
                role="tab"
                aria-controls="reportados"
              >
          ...
          <div className="col-lg-10 col-md-10 col-sm-12">
            <div className="tab-content" id="nav-tabContent">
                              ...
                              <div className="container-fluid flex-column col-lg-7 col-md-7 my-auto">
                                <div className="container-fluid">
                                  <h1 className="text-center text-dark">
                                    {' '}
                                    {
                                      this.state.infoComentarios.comentarios
                                    }{' '}
                                  </h1>
                                </div>
                                <div className="container-fluid">
              ...
              <div
                ...
                id="list-reportados"
                role="tabpanel"
                aria-labelledby="list-reportados-list"
              >
