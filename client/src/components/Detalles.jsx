          ...
          <div className="card shadow mb-4">
            <div className="card-body">
              ...
              <p className="text-justify">
                ...
                jóvenes y docentes de otras Universidades, colegios, así como de
                personas naturales y jurídicas interesadas en formar una
          ...
          <div className="card shadow mb-4">
            <div className="card-body">
              ...
              <p className="text-justify">
                ...
                comunidades, financiados con inversión pública (Impuestos de los
                ciudadanos).
              </p>
            </div>
          </div>
          <div className="card shadow mb-4">
            <div className="card-body ">
              ...
              <p className="text-justify">
                ...
                consultar y retroalimentar proyectos que se encuentren inscritos
                en el Banco de Proyectos de Inversión (BPIN) del DNP
              </p>
              <p>Nota:</p>
              <ol type="a">
                <li>
              ...
              <p className="text-justify font-weight-bold">
                ...
                responsabilidad en las decisiones relacionadas con los proyectos
                financiados con recursos públicos (impuestos ciudadanos).
              </p>
              <p className="text-justify">
              ...
              <p className="text-justify">
                b. Se planea crear equipos de jóvenes y docentes, para adelantar
                investigación interdisciplinaria de proyectos tipo
              ...
              <p className="text-justify">
                Se planea diseñar un módulo educativo lúdico para el uso de este
                sistema, dirigido a jóvenes de colegio, que incorpore además de
                lo anterior, la construcción de una visión de desarrollo
                colectiva.
              </p>
              <hr />
              <p className="text-justify font-weight-bold">
                ...
                inquietudes resultantes de la retroalimentación y participación
                ciudadana a fin de asegurar el cuidado de proyectos y recursos
                públicos.
              </p>
              <p className="text-justify">
                Se planea conformar un equipo de estudiantes de derecho y
                ciencia política para crear este mecanismo de recursos legales y
                seguimiento, que además mantenga informada a la ciudadanía del
